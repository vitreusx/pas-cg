...
// template <typename E>
// void eval_forces::fast_iter(bundle_expr<E> const &bundle) const {
//   //  if (bundle.orig_dist() - *total_disp > cutoff)
//   //    return;
//
//   auto i1 = bundle.i1(), i2 = bundle.i2();
//   if ((aa_code)atype[i1] == aa_code::PRO || (aa_code)atype[i2] ==
//   aa_code::PRO)
//     return;
//
...
//     auto rij = r[i1_] - r[i2_];
//     auto rkj = r[i3_] - r[i2_];
//     auto rkl = r[i3_] - r[i4_];
//
...
//     auto df = (fi * dot(rij, rkj) - fl * dot(rkl, rkj)) * rkj_ninv *
//     rkj_ninv; auto fj = -fi + df; auto fk = -fl - df;
//
//     dpsi1_dr1 = fi;
//     dpsi1_dr1n = fj;
//     dpsi1_dr1p = fk;
...
//
//   vect::lane<int, N, W> i1p = i1 - 1, i1n = i1 + 1, i2p = i2 - 1, i2n = i2 +
//   1;
//
...
//   auto bb_lam_2 = select_(bb_lam_2_opt, bb_plus_lam_v, bb_minus_lam_v);
//
//   mask_t bb_supp = (mask_t)(mask & bb_lam_1.supp(psi1) &
//   bb_lam_2.supp(psi2)); if (horizontal_or(bb_supp)) {
//     auto [lam1, deriv1] = bb_lam_1(psi1);
//     auto [lam2, deriv2] = bb_lam_2(psi2);
//
...
//   r12_u); F[i1n] = F[i1n] - dV_dpsi1 * dpsi1_dr1n; F[i2p] = F[i2p] - dV_dpsi2
//   * dpsi2_dr2p; F[i2] = F[i2] - (dV_dpsi1 * dpsi1_dr2 + dV_dpsi2 * dpsi2_dr2
//   + dV_dr * r12_u); F[i2n] = F[i2n] - dV_dpsi2 * dpsi2_dr2n;
// }
