#include "features/qa/sift_candidates.h"
...
void sift_candidates::iter(int idx) const {
  ...
  auto n1 = n->at(i1), n2 = n->at(i2), h1 = h->at(i1), h2 = h->at(i2);
  ...
  auto atype1 = atype->at(i1), atype2 = atype->at(i2);
  ...
  sync_data sync1_after_formation = sync->at(i1) - sync_diff1;
  ...
  sync_data sync2_after_formation = sync->at(i2) - sync_diff2;
