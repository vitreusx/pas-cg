c       The i,i+2 contacts purely repulsive
        ...
        parameter(len=90000) !maximum number of all residues together
        ...
        dimension aufres(1000000),aufres2(1000000),aree(1000000)
        dimension adfres(1000000),adfres2(1000000)
